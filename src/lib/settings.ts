...
export function normalizeSettings(value: Partial<AppSettings> | null | undefined): AppSettings {
  ...
  return {
    ...
    shoppingProvider: value?.shoppingProvider === 'bring' ? 'bring' : 'picnic',
    picnicPassword: value?.picnicPassword ?? '',
    bringEmail: value?.bringEmail ?? '',
    bringPassword: value?.bringPassword ?? '',
    bringUserUuid: value?.bringUserUuid ?? '',
    bringPublicUserUuid: value?.bringPublicUserUuid ?? '',
    bringAccessToken: value?.bringAccessToken ?? '',
    bringRefreshToken: value?.bringRefreshToken ?? '',
    bringListUuid: value?.bringListUuid ?? '',
    bringListName: value?.bringListName ?? '',
